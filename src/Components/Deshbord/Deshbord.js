...
import "./Dashbord.css";
import PendingForm from "./PendingForm/PendingForm";
          ...
          <div className="col-md-3 ">
            <div className="dashboard">
              <h5>Dashboard</h5>
              {
                user.email &&
                <span >
                  <span className="mx-auto text-primary">{user?.displayName}</span>

                </span>
              }

              <div>
                <NavLink className="menu-bar text text-black" to="/">Go Home</NavLink>
                <NavLink className="text" to={`${''}/myOrder`}>
                  <li className="menu-bar mt-3 text-black">my Orders</li>
                </NavLink>

                <NavLink className="text" to={`${''}/review`}>
                  <li className="menu-bar mt-3 text-black">Review</li>
                </NavLink>
                <NavLink className="text" to={`${''}/pay`}>
                  <li className="menu-bar mt-3 text-black">Payment</li>
                </NavLink>
              </div>

              <div className="admin-dashboard">
                {admin === 'admin' && (
                  <NavLink className="text" to={`${''}/manageOrders`}>
                    <li className="menu-bar mt-3 text-black">Manage  Orders</li>
                  </NavLink>

                )}
                {admin === 'admin' && (
                  <NavLink className="text" to={`${''}/makeAdmin`}>
                    <li className="menu-bar mt-3 text-black">Make Admin</li>
                  </NavLink>

                )}
                {admin === 'admin' && (
                  <NavLink className="text" to={`${''}/addBike`}>
                    <li className="menu-bar text-black mt-3">Add New Bike</li>
                  </NavLink>
